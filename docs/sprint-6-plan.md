...
К концу Sprint 6 приложение готово к передаче реальным пользователям: они открывают `https://beepru.ru` в Safari → «Добавить на экран "Домой"» → PWA готова к использованию.
