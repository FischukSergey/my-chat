...
Порядок относительно других спринтов: **после Sprint 7** (список/preview уже стабильны), можно до или после Sprint 8 (WebAuthn ортогонален). Рекомендация: 7 → 9 → 8 или 7 → 8 → 9; не смешивать с 7/8 в одном DoD.
